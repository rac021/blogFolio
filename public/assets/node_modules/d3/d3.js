  ...
  // Add any remaining nodes that were not bound to data to exit.
    ...
    function yesdrag(view, noclick)
    {
        ...
        if (noclick) {
            ...
            setTimeout(function () {
                selection$$1.on("click.drag", null); }, 0);
        }
        if ("onselectstart" in root) {
        ...
        function started()
        {
            if (exports.event.touches) {
                ...
                function ended()
                {
                    ...
                    if (state.selection) {
                        selection$$1 = state.selection; // May be set by brush.move (on start)!
                    }
                    ...
                    switch (exports.event.keyCode) {
                        ...
                        case 32: { // SPACE; takes priority over ALT
                            if (mode === MODE_HANDLE || mode === MODE_CENTER) {
                                if (signX < 0) {
                                    e0 = e1 - dx; } else if (signX > 0) {
                                                    w0 = w1 - dx;
                                    }
                                    if (signY < 0) {
                                        s0 = s1 - dy; } else if (signY > 0) {
                                                  n0 = n1 - dy;
                                        }
                                        mode = MODE_SPACE;
                ...
                function keyupped()
                {
                    switch (exports.event.keyCode) {
                        ...
                        case 18: { // ALT
                            if (mode === MODE_CENTER) {
                                if (signX < 0) {
                                    e0 = e1; } else if (signX > 0) {
                                                    w0 = w1;
                                    }
                                    if (signY < 0) {
                                        s0 = s1; } else if (signY > 0) {
                                                  n0 = n1;
                                        }
                                        mode = MODE_HANDLE;
                                        move();
    ...
    var dsv = function (delimiter) {
        ...
        function parseRows(text, f)
        {
            ...
            function token()
            {
                ...
                if (eol) {
                    return eol = false, EOL; // special case: end of line
                }
              ...
              // common case: find next delimiter or newline
                while (I < N) {
                    ...
                    if (c === 10) {
                        ...
                        eol = true; if (text.charCodeAt(I) === 10) {
                                ++I, ++k;
                        } } // \r|\r\n
...
// http://egsc.usgs.gov/isb/pubs/MapProjections/projections.html#albers
    var albersUsa = function () {
        var cache,
          ...
          point, pointStream = {point: function (x, y) {
            point = [x, y]; }};
    ...
    var stratify = function () {
        ...
        function stratify(data)
        {
            ...
            root.eachBefore(function (node) {
                node.depth = node.parent.depth + 1; --n; }).eachBefore(computeHeight);
            root.parent = null;
            if (n > 0) {
...
// Returns an array of indices into points in left-to-right order.
    ...
    function poke$1(q)
    {
        if (!q._start) {
            try {
                start$1(q); } // let the current task complete
            catch (e) {
...
// http://mathworld.wolfram.com/Circle-LineIntersection.html
    ...
    var radialArea = function () {
        ...
        a.lineStartAngle = function () {
            return radialLine(x0()); }, delete a.lineX0;
        a.lineEndAngle = function () {
            return radialLine(x1()); }, delete a.lineX1;
        a.lineInnerRadius = function () {
            return radialLine(y0()); }, delete a.lineY0;
        a.lineOuterRadius = function () {
            return radialLine(y1()); }, delete a.lineY1;
              ...
              .tween("zoom", function () {
                ...
                return function (t) {
                    if (t === 1) {
                        ...
                        var l = i(t), k = w / l[2]; t = new Transform(k, p[0] - l[0] * k, p[1] - l[1] * k); }
                    g.zoom(null, t);
                };
              });
        }
